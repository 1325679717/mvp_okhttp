...
public class StringUtill {
    ...
    public static SpannableString setSpannableSize(String content, int size){
        SpannableString spannableString = new SpannableString(content);
        spannableString.setSpan(new AbsoluteSizeSpan(size,true),0,content.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        return spannableString;
    }
    public static SpannableString setSpannableColor(String content, Context context, int color){
        SpannableString contentSs = new SpannableString(content);
        contentSs.setSpan(new ForegroundColorSpan(context.getResources().getColor(color)),0,content.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        return contentSs;
    }
